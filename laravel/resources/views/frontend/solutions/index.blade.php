          ...
          <div class="container">
            <article class="article">
              <div class="img-box viewport-holder slideDown delay-1">
                <img
                  src="../images/Solutions/Transport-and-storage.png"
            ...
            <article class="article">
              <div class="img-box viewport-holder slideDown delay-1">
                <img
                  src="../images/Solutions/Public-Safety.png"
                  alt="image description"
                />
              </div>
              <div class="text-box">
            ...
            <article class="article">
              <div class="img-box viewport-holder slideDown delay-1">
                <img
                  src="../images/Solutions/Retail.png"
                  alt="image description"
                />
              </div>
              <div class="text-box">
            ...
            <article class="article">
              <div class="img-box viewport-holder slideDown delay-1">
                <img
                  src="../images/Solutions/HealthCare.png"
                  alt="image description"
                />
              </div>
              <div class="text-box">
