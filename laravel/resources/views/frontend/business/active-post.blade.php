                    ...
                    <div class="align-right">
                        <div class="video-holder  viewport-holder slideDown delay-2">
                            <video width="100%" height="320" loop="true" autoplay="autoplay" muted>
                                ...
                                <source src="https://drive.google.com/uc?id=1iSshUZfVzp0XQDzpCXiY-YbzFH9oLBTk"
                                    type="video/mp4">
                    ...
                    <div class="viewport-holder slideDown delay-1">
                        ...
                        <div class="text">
                            ...
                            <p>Default alarming event colouring
                                ...
                                experience and consultations with leading experts in the field of trade, as a result of
                                which
                                ActivePOS independently monitors possible violations in the work of the cashier and, if
                                detected, immediately notifies the operator. The detectors are created in the form of
                                plug-in
                                ...
                                unique reports, are provided to analysts and can be verified by manual event search, which
                                in
                            ...
                            <p>The system saves not the receipt text but the sales events, cancellations, refunds, annulment
                                etc in the database. Also there is capability of data search in any combination of facts,
                                receipt
