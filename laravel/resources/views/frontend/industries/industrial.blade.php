          ...
          <div class="container">
            <strong class="logo">
              <a href="../index.html">
                <img
                  src="../images/logo.svg"
                  alt="RRSTEK | Home Automation System"
                />
              </a>
            </strong>
            <nav id="nav">
              ...
              <div class="box">
                ...
                <div id="text-banner-overview" class="text">
                  ...
                  <ul class="viewport-holder slideDown delay-3">
                    <li><a href="../Solutions/index.html" class="btn sec w-spe-btn-m">Get Solutions</a></li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div class="container">
            <article class="article">
              <div class="img-box viewport-holder slideDown delay-1">
                <img
                  src="../images/Industries/Industrial/ProductionEfficiency.png"
            ...
            <article class="article">
              <div class="img-box viewport-holder slideDown delay-1">
                <img
                  src="../images/Industries/Industrial/InternalFactorsSecurity.png"
                  alt="image description"
                />
              </div>
              <div class="text-box">
            ...
            <article class="article">
              <div class="img-box viewport-holder slideDown delay-1">
                <img
                  src="../images/Industries/Industrial/TechnicalServiceSecurity.png"
                  alt="image description"
                />
              </div>
              <div class="text-box">
              ...
              <div class="mask">
                <div class="slideset">
                  <div class="slide viewport-holder slideDown">
                    <div class="frame">
                      <img
                        src="../images/Industries/Industrial/HardHatDetector.png"
                        alt="image description"
                      />
                      <div class="txt-box">
                        <a href="../work-safety/hardhat-detector.html" class="more">Hardhat Detector</a>
                      </div>
                    </div>
                  </div>
                  <div class="slide viewport-holder slideDown delay-1">
                    <div class="frame">
                      <img
                        src="../images/Industries/Industrial/SocialDistanceDetector.png"
                        alt="image description"
                      />
                      <div class="txt-box">
                  ...
                  <div class="slide viewport-holder slideDown delay-2">
                    <div class="frame">
                      <img
                        src="../images/Industries/Industrial/WorkSpaceDetector.png"
                        alt="image description"
                      />
                      <div class="txt-box">
                        <a href="../Business/workspace-detector.html" class="more">Workspace Detector</a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="slide viewport-holder slideDown delay-1">
                ...
                <div class="txt">
                  ...
                  <h4>
                    <i class="ico"
                      ><img
                        src="../images/ico-location-solid.svg"
                        alt="image description"
                    /></i>
