		...
		<div class="link-holder">
			<div class="container">
				<ul class="links viewport-holder slideDown">
					<li><a href="face-mask-detector.html">Face Mask Detector</a></li>
					<li><a href="social-distance-detector.html">Social Distance Detector</a></li>
					<li><a href="thermal-camera.html">Thermal Camera</a></li>
			</div>
		</div>
		<main id="main">
				...
				<div class="container">
					<article class="article">
						<div class="img-box viewport-holder slideDown delay-1">
							<img src="../images/Health-care/Facemask_detector.png" alt="image description" />
						</div>
						<div class="text-box">
							...
							<p class="viewport-holder slideDown delay-3">
								The Face Mask Detector module is designed to monitor compliance with security measures in a pandemic or
					...
					<article class="article">
						<div class="img-box viewport-holder slideDown delay-1">
							<img src="../images/Health-care/SocialDistance_Detector.png" alt="image description" />
						</div>
						<div class="text-box">
							<h2 class="viewport-holder slideDown delay-2">
							...
							<p class="viewport-holder slideDown delay-3">
								The Social Distance Detector module is designed to monitor the observance of social distance between
								people in queues and in public places characterized by a crowd of people.
							</p>
							<a href="social-distance-detector.html" class="viewport-holder slideDown delay-4 more"><span>Read
									More</span></a>
						</div>
					</article>
					<article class="article">
						<div class="img-box viewport-holder slideDown delay-1">
							<img src="../images/Health-care/Thermal_camera.png" alt="image description" />
						</div>
						<div class="text-box">
							<h2 class="viewport-holder slideDown delay-2">
							...
							<p class="viewport-holder slideDown delay-3">
								The Thermal Camera module is intended to connect a thermal imaging camera to Trassir OS. It displays not only video data, but also the information of changing the body temperature of a person.
							</p>
							<a href="thermal-camera.html" class="viewport-holder slideDown delay-4 more"><span>Read More</span></a>
						</div>
					</article>
				</div>
			</div>
					...
					<div class="slick-slider-add">
						<div class="slide viewport-holder slideDown delay-1">
							...
							<div class="txt">
								...
								<h4>
									<i class="ico"><img src="../images/ico-location-solid.svg" alt="image description" /></i>
