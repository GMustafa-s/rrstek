						...
						<div class="align-right">
							<div class="video-holder  viewport-holder slideDown delay-2">
								<video width="100%" height="320" loop="true" autoplay="autoplay" muted>
									<source src="../images/videos/Fisheye.mp4" type="video/mp4">
				...
				<div class="container">
					<div class="post">
						<div class="viewport-holder slideDown">
							...
							<div class="text">
								<p>The Thermal Camera module is intended to connect a thermal imaging camera to RRSTEK OS. It displays not only video data, but also the information of changing the body temperature of a person.</p>
