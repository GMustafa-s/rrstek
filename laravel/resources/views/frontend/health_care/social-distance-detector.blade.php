					...
					<div class="container">
						<div class="box">
							<ul class="breadcrumbs viewport-holder slideDown">
								...
								<li><a href="#">Social Distance Detector</a></li>
							</ul>
							<div class="text">
						...
						<div class="align-right">
							<div class="video-holder  viewport-holder slideDown delay-2">
								<video width="100%" height="320" loop="true" autoplay="autoplay" muted>
									<source src="../images/videos/Social Distance Detector_4.mp4" type="video/mp4">
						...
						<div class="viewport-holder slideDown">
							...
							<div class="text">
								<p>Neural network software, works only on Neuro Station series DVRs.
									The Social Distance Detector module is designed to monitor the observance of social distance between people in queues and in public places characterized by a crowd of people.</p>
					...
					<div class="product-box">
						<div class="frame viewport-holder slideDown delay-1">
							...
							<ul class="accordion" data-accordion="close">
								<!-- <li>
									<a href="social-distance-detector.html">Social Distance Detector</a>
									
								</li> -->
								<li>
									<a  href="thermal-camera.html">Thermal Detector</a>
									
								</li>
								<li>
									<a href="face-mask-detector.html">Face Mask Detector</a>
