							...
							<div class="holder">
								<ul class="list">
									...
									<li class="has-dropdown">
										<a href="/Business/index.html" class="title">BUSINESS</a>
										<ul class="link">
									...
									<li class="has-dropdown">
										<a href="/Solutions/index.html" class="title">SOLUTIONS</a>
										<ul class="link">
											<li><a href="#" class="nav-back">Back</a></li>
											<!-- <li><span class="label">Text Label</span></li> -->
								...
								<ul class="list">
									<li class="has-dropdown">
										<a href="/about-rrstek.html" class="title">ABOUT US</a>
										<ul class="link">
											<li><a href="#" class="nav-back">Back</a></li>
											<!-- <li><span class="label">Text Label</span></li> -->
		...
		<main id="main">
				...
				<div class="container">
					...
					<div class="slick-slider-compare">
						<div class="slide viewport-holder slideDown delay-5">
							<div class="img">
								<img src="../../images/products/camera-04.png" alt="image description">
							</div>
							<div class="txt">
					...
					<div class="product-frame">
						<table class="table">
							<thead>
								...
								<td>
									<div class="box">
										<img src="../../images/products/camera-01.png" alt="image discription">
										<span class="model">TR-D2181IR3 v2 3.6</span>
									</div>
								</td>
								<td>
									<div class="box dash">
										<img src="../../images/ico-upload-file.png" alt="image discription">
			...
			<div class="contact-form">
				<div class="container">
					...
					<form action="#" class="viewport-holder slideDown delay-1">
						<div class="holder">
							<div class="cols">
								<div class="rows viewport-holder slideDown delay-1">
									<label for="first-name">First Name <sup>*</sup></label>
									<input class="form-control" id="first-name" type="text" placeholder="First Name" required>
								</div>
								<div class="rows viewport-holder slideDown delay-2">
									<label for="last-name">Last Name <sup>*</sup></label>
									<input class="form-control" id="last-name" type="text" placeholder="Last Name" required>
								</div>
								<div class="rows viewport-holder slideDown delay-3">
							...
							<div class="cols">
								<div class="rows viewport-holder slideDown delay-1">
									...
									<input class="form-control" id="region" type="text" placeholder="Region/Country" required>
								</div>
								<div class="rows viewport-holder slideDown delay-2">
									<label for="message">Message</label>
									<textarea class="form-control" id="message" cols="30" rows="10" placeholder="Let us know about your needs, interest, and other quetions."></textarea>
								</div>
							</div>
						</div>
						...
						<div class="box">
							<div class="captcha viewport-holder slideDown delay-4">
								<img src="../../images/captcha.jpg" alt="captcha">
							</div>
							<input class="login-btn" type="submit" value="Send" class="viewport-holder slideDown delay-5">
						</div>
					</form>
				</div>
			</div>
