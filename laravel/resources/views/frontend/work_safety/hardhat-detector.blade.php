            ...
            <div class="container">
              <div class="box">
                <ul class="breadcrumbs viewport-holder slideDown">
                  ...
                  <li><a href="index.html">Work Safety</a></li>
                  <li><a href="#">Hardhat Detector</a></li>
                </ul>
                <div class="text">
              ...
              <div class="align-right">
                <div class="video-holder viewport-holder slideDown delay-2">
                  ...
                  >
                    <source
                      src="../images/videos/video-01.mp4"
                      type="video/mp4"
                    />
            ...
            <div class="product-box">
              <div class="frame viewport-holder slideDown delay-1">
                ...
                <ul class="accordion" data-accordion="close">
                  <!-- <li>
                    <a href="hardhat-detector.html">Hardhat Detector </a>
                  </li> -->
                  <li>
                    <a href="wear-detector.html">Wear Detector</a>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div class="contact-form">
          <div class="container">
            <h3 class="viewport-holder slideDown">
              <span>Our Customers</span> Contact Sales for questions or a live
              video security demo
            </h3>
