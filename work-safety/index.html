		...
		<div class="link-holder">
			<div class="container">
				<ul class="links viewport-holder slideDown">
					<li><a href="hardhat-detector.html">Hardhat Detector</a></li>
					<li><a href="wear-detector.html">Wear Detector</a></li>
			</div>
		</div>
		<main id="main">
				...
				<div class="container">
					<article class="article">
						<div class="img-box viewport-holder slideDown delay-1">
							<img src="../images/work-safety/wear-detector-Image.png" alt="image description" />
						</div>
						<div class="text-box">
					...
					<article class="article">
						<div class="img-box viewport-holder slideDown delay-1">
							<img src="../images/work-safety/hardhat-detector-Image.png" alt="image description" />
						</div>
						<div class="text-box">
							<h2 class="viewport-holder slideDown delay-2">
