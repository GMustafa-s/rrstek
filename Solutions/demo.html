				  ...
				  <div class="box">
					...
					<div id="#text-banner-overview" class="text">
					  <h1 class="viewport-holder slideDown delay-1">Get a demo
						of your
						business</h1>
					  <p class="viewport-holder slideDown delay-2">Get a detailed demo of the services based on the example of your business.
					  </p>
				...
				<div class="container">
					...
					<div class="holder">
						<div class="text-box viewport-holder slideDown delay-3">
							<i class="ico"><img src="../images/Solutions/demo-Icon (Stroke).png" alt="image description"></i>
							<div class="frame">
								<p>Fill the form bellow</p>
							</div>
						</div>
						<div class="text-box viewport-holder slideDown delay-4">
							<i class="ico"><img src="../images/Solutions/demo-Icon (msgs).png" alt="image description"></i>
							<div class="frame">
								<p>We will get in touch shortly<br>and discuss the time</p>
							</div>
						</div>
						<div class="text-box viewport-holder slideDown delay-5">
							<i class="ico"><img src="../images/Solutions/demo-Icon (analysis).png" alt="image description"></i>
							<div class="frame">
				...
				<div class="container">
				  ...
				  <article id="image-left-aligned"  class="article">
					<div  class="img-box viewport-holder slideDown delay-1">
					  <img
						src="..//images/Solutions/demo-article-Image.png"
					...
					<div class="text-box">
					  ...
					  <a href="/cases/index.html" class="viewport-holder slideDown delay-4 more"
						><span>see cases</span></a
					  >
					</div>
				  </article>
				</div>
