          ...
          <div class="container">
            <article class="article">
              <div class="img-box viewport-holder slideDown delay-1">
                <img
                  src="../images/Industries/Healthcare/improvingProductivity.png"
            ...
            <article class="article">
              <div class="img-box viewport-holder slideDown delay-1">
                <img
                  src="../images/Industries/Healthcare/LegalTroubles.png"
                  alt="image description"
                />
              </div>
              <div class="text-box">
            ...
            <article class="article">
              <div class="img-box viewport-holder slideDown delay-1">
                <img
                  src="../images/Industries/Healthcare/Spreading-Covid19.png"
                  alt="image description"
                />
              </div>
              <div class="text-box">
              ...
              <div class="mask">
                <div class="slideset">
                  <div class="slide viewport-holder slideDown">
                    <div class="frame">
                      <img
                        src="../images/Industries/Healthcare/Thermal-Camera.png"
                        alt="image description"
                      />
                      <div class="txt-box">
                        <a href="../health-care/thermal-camera.html" class="more">Thermal Camera</a>
                      </div>
                    </div>
                  </div>
