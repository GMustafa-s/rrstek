            ...
            <div class="container">
              <div class="box">
                <ul class="breadcrumbs viewport-holder slideDown">
                  ...
                  <li><a href="../Solutions/index.html">Solutions</a></li>
                  <li><a href="transport-and-storage.html">Transport and storage</a></li>
                </ul>
          ...
          <div class="container">
            <article class="article">
              <div class="img-box viewport-holder slideDown delay-1">
                <img
                  src="../images/Industries//transport-and-storage/Constant-Monitoring.png"
            ...
            <article class="article">
              <div class="img-box viewport-holder slideDown delay-1">
                <img
                  src="../images/Industries//transport-and-storage/Site-security.png"
                  alt="image description"
                />
              </div>
              <div class="text-box">
            ...
            <article class="article">
              <div class="img-box viewport-holder slideDown delay-1">
                <img
                  src="../images/Industries//transport-and-storage/Fire-prevention.png"
                  alt="image description"
                />
              </div>
              <div class="text-box">
              ...
              <div class="mask">
                <div class="slideset">
                  <div class="slide viewport-holder slideDown">
                    <div class="frame">
                      <img
                        src="../images/Industries/transport-and-storage/Neuro-detector.png"
                        alt="image description"
                      />
                      <div class="txt-box">
                        <a href="../security/neuro-detector.html" class="more">Neuro Detector</a>
                      </div>
                    </div>
                  </div>
